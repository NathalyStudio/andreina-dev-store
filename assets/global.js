...
class VariantSelects extends HTMLElement {
  ...
  updateActiveColorAndSize() {
    const colorLabel = document.querySelector(".form__label-color");
    const sizeLabel = document.querySelector(".form__label-size");
    colorLabel.innerHTML = this.currentVariant.option1;
    sizeLabel.innerHTML = this.currentVariant.option2;
  }
